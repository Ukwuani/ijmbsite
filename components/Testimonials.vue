<template>
    <section class="AlphaTestimonials" id="testimonials">
        <h1 class="h2 text-center my-1 Fredoka text-primary">Testimonials</h1>
        <div class="AlphaTestimonial columns AlphaCategory">
            <div class="column col-4 col-sm-12 col-md-6" v-for="testimonial in testimonials" :key="testimonial.author">
                <div class="AlphaTestimonialImage">
                    <img :src="testimonial.image" :alt="'Picture of ' + testimonial.author" v-if="testimonial.image" />
                    <i class="icon icon-people icon-2x" v-else></i>
                </div>
                <h6 class="h5 text-bold">{{ testimonial.author }}</h6>
                <h2 class="h6">{{ testimonial.package }}</h2>
                <p>
                    {{ testimonial.comment }}
                </p>
            </div>
            ...
            return {
                testimonials: [
                    ...
                    },
                    {
                        ...
                        image: '/img/zeal.jpg',
                        comment: "I enrolled for IJMB A'level programme through IJMB & JUPEB Alevels last year after! After years of seeking admission. Completing the 9-months of IJMB, I was offered admission to study Economics in the University of Ilorin.",
                        package: 'IJMB'
                    },
                    ...
                    // },
                    {
                        ...
                        comment: "It is interesting to note that IJMB & ALPHA ALEVLES are moving in the right direction to enhance academics performance by giving young people like myself the opportunity to further their edu! Keep up the good Job.",
                        package: 'IJMB'
                    },
                    // {
...
.AlphaTestimonials .AlphaTestimonial {
    /* transform: scale(1); */
}

.AlphaTestimonials .AlphaTestimonial .column {
    display: flex;
    align-items: center;
